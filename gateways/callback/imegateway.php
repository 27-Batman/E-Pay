...
$success = $_POST["ResponseCode"];
$invoiceId = $_POST["RefId"];
$transactionId = $_POST["TransactionId"];
$paymentAmount = $_POST["TranAmount"];
$paymentFee = "0";
...
if ($success==0 && ($invoiceId != null || $invoiceId !='') && ($transactionId != null || $transactionId !='') && ($paymentAmount != null || $paymentAmount !='')) {
